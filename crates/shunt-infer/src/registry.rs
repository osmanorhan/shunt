...
/// Qwen3 / QwQ — thinking models.
/// Sampling: Unsloth defaults often work well here (temp=0.7, top-p=0.8,
/// top-k=20, presence_penalty=1.5 to break action-repetition loops).
...
/// DeepSeek-R1 / R1-Distill — thinking model.
...
/// DeepSeek other (coder, v2, v3) — non-thinking.
